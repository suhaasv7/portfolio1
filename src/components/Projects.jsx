const links = [
  {
    ...
    imageUrl: "/website/portfolio-main.png",
  },
  {
...
export default function Projects() {
  return (
    <div>
      <h1 className="text-2xl font-bold text-[#374151] mt-10 pl-10">
        Projects
      </h1>
      <div className="grid items-center justify-center w-full h-full grid-cols-1 my-10 rounded-md gap-y-10 md:grid-cols-2 lg:grid-cols-3">
        {links.map(({ title, link, imageUrl }) => (
          <a
            ...
            className=" w-[350px] h-[200px] mx-auto flex justify-left items-end p-3 text-lg text-white rounded-2xl"
            style={{
